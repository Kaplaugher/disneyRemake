    ...
    <div class="my-8">
        ...
        >
          <vue-glide-slide>
            <router-link
              to="/about"
              href="#"
              class="bg-gray-800 h-32 flex justify-center items-center shadow-custom border border-gray-700 rounded-lg p-4 hover:bg-gray-900"
            >
      ...
      <div class="disney-plus-originals px-6 mb-12">
        ...
        >
          <vue-glide-slide>
            <router-link to="/about"
              ><img src="@/assets/lady_and_the_tramp.jpg" alt="star wars"
            /></router-link>
          </vue-glide-slide>
          <vue-glide-slide>
            <router-link to="/about"
              ><img src="@/assets/the_mandalorian.jpg" alt="snow white"
            /></router-link>
          </vue-glide-slide>
          <vue-glide-slide>
            <router-link to="/about"
              ><img src="@/assets/high_school_musical.jpg" alt="zootopia"
            /></router-link>
          </vue-glide-slide>
          <vue-glide-slide>
            <router-link to="/about"
              ><img
                src="@/assets/forky_asks_a_question.jpg"
                alt="one strange rock"
            /></router-link>
          </vue-glide-slide>
          <vue-glide-slide>
            <router-link to="/about"
              ><img
                src="@/assets/marvel_hero_project.jpg"
                alt="one strange rock"
            /></router-link>
          </vue-glide-slide>
          <vue-glide-slide>
      ...
      <div class="trending-now px-6 mb-12">
        ...
        >
          <vue-glide-slide>
            <router-link to="/about"
              ><img src="@/assets/avengers_endgame.jpg" alt="star wars"
            /></router-link>
          </vue-glide-slide>
          <vue-glide-slide>
            <router-link to="/about"
              ><img src="@/assets/avengers_infinity_war.jpg" alt="snow white"
            /></router-link>
          </vue-glide-slide>
          <vue-glide-slide>
            <router-link to="/about"
              ><img src="@/assets/black_panther.jpg" alt="zootopia"
            /></router-link>
          </vue-glide-slide>
          <vue-glide-slide>
            <router-link to="/about"
          ...
          <vue-glide-slide>
            <router-link to="/about"
              ><img src="@/assets/zootopia.jpg" alt="one strange rock"
            /></router-link>
          </vue-glide-slide>
          <vue-glide-slide>
            <router-link to="/about"
